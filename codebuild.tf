...
resource "aws_codebuild_project" "build" {
  count         = contains(var.pipeline_types,"build-unit-deploy") || contains(var.pipeline_types,"build-deploy") || contains(var.pipeline_types,"build-unit") || contains(var.pipeline_types,"build-publish") || contains(var.pipeline_types,"build") ? 1 : 0
...
resource "aws_codebuild_project" "unit_tests" {
  count         = contains(var.pipeline_types,"build-unit-deploy") || contains(var.pipeline_types,"build-unit") ? 1 : 0
